...
from scripts.core.core_utils import get_html_from_markdown
import scripts.core.shell_super_functions as super_functions
...
class Shell():
    ...
    def run_parsed(self):
        ...
        super_functions.script_ID = self.Script.script_id
        #--------
